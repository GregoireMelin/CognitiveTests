...
{
    public partial class Test5ProblemesPhysiques : Form
    {
        #region Variables Globales
        public int numeroQuestion;
        public int nbBonnesReponses;
        public List<Question> questionsPhysiques;
        public Question questionEnCours;

        //Function pour avoir int random
        ...
        public Test5ProblemesPhysiques()
        {
            InitializeComponent();

            // chargement des questions une fois pour toute
            questionsPhysiques = Program.chargerQuestions((Program.difficulte == "Mode normal") ? "questionsPhysiqueFaciles.xml" : "questionsPhysiqueDifficiles.xml");
        ...
        {
            int indexQuestion = GetRandomNumber(0, questionsPhysiques.Count());
            questionEnCours = questionsPhysiques[indexQuestion];
            questionsPhysiques.Remove(questionEnCours);
        }
        ...
        private void questionSuivante_Click(object sender, EventArgs e)
        {
            if (numeroQuestion == 10)
            {
                ...
                finP.Show();
                retourMenuBtn.Focus();
                Program.U.resultatsParTests[4] = nbBonnesReponses * 10;
            }
            else
            {
        ...
        private void Test5ProblemesPhysiques_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void Test5ProblemesPhysiques_KeyPress(object sender, KeyPressEventArgs e)
        {
